//-----------------------------------------------------------------------
// <copyright file="Hash.cs" company="https://dudley.codes">
...
namespace DudleyCodes
{
    ...
    /// <summary>Library of various one-way hashing algorithms. Modifying function outputs after this library has been
    /// used in production can and will break the application (particularly from database reads).</summary>
    public class Hash
    {
